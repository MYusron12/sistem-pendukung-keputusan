        ...
        <tbody>
          ...
          <?php foreach ($kriteria as $k) : ?>
            <tr>
              ...
              <td>
                <a href="<?= base_url('spk/editKriteria/') . $k['id']; ?>" class="badge badge-success">edit</a>
                <a href="<?= base_url('spk/hapusKriteria/') . $k['id']; ?>" class="badge badge-danger" onclick="return confirm('Apakah akan dihapus?')">delete</a>
              </td>
            </tr>
            <?php $i++; ?>
          <?php endforeach; ?>
